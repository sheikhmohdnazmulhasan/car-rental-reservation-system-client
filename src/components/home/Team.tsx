            ...
            <div className="container px-6 py-8 mx-auto">
                <div className="relative mx-auto max-w-5xl text-center">
                    ...
                    <p
                        ...
                        Our RentNGo team is a passionate group of professionals dedicated to providing you with a seamless car rental experience.
                    </p>
                </div>
                ...
                <div className="grid gap-8 mt-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div className="w-full max-w-xs text-center">
                        ...
                        <div className="mt-2">
                            <h3 className="text-lg font-medium text-gray-700">Patterson Johnson</h3>
                            <span className="mt-1 font-medium text-gray-600">Software Engineer</span>
                        </div>
                    </div>
                </div>
            </div>
